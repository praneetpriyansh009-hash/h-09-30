...
import { z } from 'zod';
import { Mail, Lock, ArrowRight, Loader2, Sparkles, Phone, MessageSquare } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full blur-[100px] pointer-events-none"
        style={{
      ...
      <Link to="/" className="absolute top-8 left-8 z-20 group flex items-center gap-2">
        <div className="w-10 h-10 rounded-xl bg-white/[0.05] border border-white/[0.1] flex items-center justify-center text-white font-bold group-hover:border-neon-pink/50 transition-all">
          H
        </div>
      ...
      >
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-[1px] bg-gradient-to-r from-transparent via-neon-pink to-transparent opacity-50" />
        ...
        <div className="text-center mb-8">
          <motion.div 
            ...
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-neon-pink to-neon-violet flex items-center justify-center text-white mx-auto mb-6 shadow-[0_0_30px_rgba(225,29,72,0.4)]"
          >
            <Sparkles className="w-8 h-8" />
          </motion.div>
          <h1 className="text-3xl font-heading font-bold text-white mb-2 tracking-tight">Welcome Back</h1>
          <p className="text-white/40 font-display">Sign in to continue planning your masterpiece.</p>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-white/30 text-xs font-medium uppercase">Or continue with</span>
          <div className="h-[1px] flex-1 bg-white/[0.08]" />
        </div>
            ...
            >
              ...
              <div className="space-y-2 relative group">
                <div className="flex justify-between items-center ml-1">
                  ...
                  <Link to="#" className="text-sm text-neon-pink hover:text-neon-pink/80 transition-colors font-medium">Forgot?</Link>
                </div>
                <div className="relative">
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full h-14 text-base font-bold rounded-2xl bg-gradient-to-r from-neon-pink to-neon-violet hover:from-neon-pink/90 hover:to-neon-violet/90 text-white shadow-[0_0_30px_rgba(225,29,72,0.3)] transition-all hover:shadow-[0_0_40px_rgba(225,29,72,0.5)] mt-4"
              >
              ...
              {!confirmationResult ? (
                <form onSubmit={handleSendOTP} className="space-y-5">
                  <div className="space-y-2 relative group">
                    ...
                    <div className="relative">
                      <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/30 group-focus-within:text-neon-cyan transition-colors" />
                      <Input
                        id="phone"
                        type="tel"
                        ...
                        className="pl-12 h-14 bg-white/[0.03] border-white/[0.08] focus-visible:ring-neon-cyan focus-visible:border-neon-cyan/50 rounded-2xl text-base text-white placeholder:text-white/20 transition-all hover:bg-white/[0.05]"
                      />
                    </div>
                  ...
                  <Button 
                    type="submit" 
                    disabled={isLoading}
                    className="w-full h-14 text-base font-bold rounded-2xl bg-gradient-to-r from-neon-cyan to-blue-500 hover:opacity-90 text-white shadow-[0_0_30px_rgba(6,182,212,0.3)] transition-all hover:shadow-[0_0_40px_rgba(6,182,212,0.5)] mt-4"
                  >
                ...
                <form onSubmit={handleVerifyOTP} className="space-y-5">
                  <div className="space-y-2 relative group">
                    <div className="flex justify-between items-center ml-1">
                      ...
                      <button type="button" onClick={() => setConfirmationResult(null)} className="text-sm text-neon-cyan hover:text-white transition-colors">Change number</button>
                    </div>
                    <div className="relative">
                      <MessageSquare className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/30 group-focus-within:text-neon-cyan transition-colors" />
                      <Input
                        id="otp"
                        type="text"
                        placeholder="123456"
                        ...
                        className="pl-12 h-14 bg-white/[0.03] border-white/[0.08] focus-visible:ring-neon-cyan focus-visible:border-neon-cyan/50 rounded-2xl text-base text-white tracking-widest placeholder:text-white/20 transition-all hover:bg-white/[0.05]"
                      />
                    </div>
                  </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.06] text-center">
          <p className="text-white/40 font-display">
            ...
            <Link to="/register" className="text-white font-semibold hover:text-neon-pink transition-colors">
              Create one
            </Link>
          </p>
        </div>
